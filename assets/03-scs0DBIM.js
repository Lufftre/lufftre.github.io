import"./modulepreload-polyfill-9p4a8sJU.js";const l=`.....................................164.................429.35...........221....................................................34.........
...
.........................577...............144....906..........864.........416...............45.........73........388.............689...11..`;document.querySelector("#input").innerHTML=l;let r=String(l);const t=r.search(`
`);r=r.replaceAll(`
`,"");const i=[...r.matchAll(/\d+/g)],u=[-t-1,-t,-t+1,-1,1,t-1,t,t+1],f=[];function a(n){for(let e=n.index;e<n.index+n[0].length;e++)for(const o of u){const $=e+o;if(r.charAt($).match(/[^0-9\.]/))return!0}return!1}for(const n of i){const e=parseInt(n[0]);a(n)&&f.push(e)}const h=f.reduce((n,e)=>n+e);console.log(h);const c={};function p(n){const e=parseInt(n[0]);for(let o=n.index;o<n.index+n[0].length;o++)for(const $ of u){const s=o+$;if(r.charAt(s)=="*"){s in c?c[s].push(e):c[s]=[e];return}}}for(const n of i)parseInt(n[0]),p(n);const g=Object.values(c).reduce((n,e)=>e.length==2?e[0]*e[1]+n:n,0);console.log(g);
